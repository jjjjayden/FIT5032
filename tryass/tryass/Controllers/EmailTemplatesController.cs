...
namespace tryass.Controllers
{
    public class EmailTemplatesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Name,Subject,Content")] EmailTemplate emailTemplate)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Name,Subject,Content")] EmailTemplate emailTemplate)
        {
            if (ModelState.IsValid)
            {
